...
class RadioGroup extends PureComponent {
  ...
  static propTypes = {
    ...
    radioContainerStyle: PropTypes.object,
  };
  ...
  render() {
    const { options, horizontal, circleStyle, style, radioContainerStyle } = this.props;
    return (
      <View style={[styles.container, horizontal && { flexDirection: 'row' }, style]}>
        {options.map(option => (
          <TouchableOpacity
            key={option.id}
            style={[styles.radio, radioContainerStyle]}
